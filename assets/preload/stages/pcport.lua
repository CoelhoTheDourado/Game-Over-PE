...
function onUpdate(elapsed)
	...
	elseif not trigger then
		trigger = true
		addLuaSprite('botplayTxt')
	end
	
	if getPropertyFromClass('flixel.FlxG', 'keys.justPressed.ENTER') or mouseReleased() and not pressedEnter then
		pressedEnter = true
